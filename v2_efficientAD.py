...
from v2_common import get_autoencoder, get_pdn_small, get_pdn_medium, ImageFolderWithoutTarget, ImageFolderWithPath, InfiniteDataloader
...
def main():
    ...
    dataset_path = "ingot"  # path to the dataset

    # create output dir
    train_output_dir = os.path.join("output/2", "trainings")
    test_output_dir = os.path.join("output/2", "anomaly_maps", "test")
    ...
    state_dict = torch.load("models\\teacher_small.pth", map_location='cpu')
    ...
    scheduler = torch.optim.lr_scheduler.StepLR(
        optimizer, step_size=int(0.95 * 7000), gamma=0.1)
    tqdm_obj = tqdm(range(7000))
